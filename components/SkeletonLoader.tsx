  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        ...
        <Animated.View style={[styles.text, { backgroundColor, width: "100%" }]} />
        <Animated.View style={[styles.text, { backgroundColor, width: "100%" }]} />
        <Animated.View style={[styles.text, { backgroundColor, width: "70%" }]} />
        <Animated.View style={[styles.text, { backgroundColor, width: "80%" }]} />
        <Animated.View style={[styles.text, { backgroundColor, width: "100%" }]} />
        <Animated.View style={[styles.text, { backgroundColor, width: "40%" }]} />
        <Animated.View style={[styles.text, { backgroundColor, width: "100%" }]} />
        <Animated.View style={[styles.text, { backgroundColor, width: "100%" }]} />
        <Animated.View style={[styles.text, { backgroundColor, width: "90%" }]} />
        <Animated.View style={[styles.text, { backgroundColor, width: "100%" }]} />
        <Animated.View style={[styles.text, { backgroundColor, width: "90%" }]} />
        <Animated.View style={[styles.text, { backgroundColor, width: "80%" }]} />
